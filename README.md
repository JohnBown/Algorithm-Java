...
2. 图算法：
    - 图的深度优先遍历和广度优先遍历
    - 最短路径（dijkstra，bellman-ford，floyd，heap+dijkstra）（[poj1860](src/EarlyStage/GraphAlgs/poj1860.java)，[poj3259](src/EarlyStage/GraphAlgs/poj3259.java)，[poj1062](src/EarlyStage/GraphAlgs/poj1062.java)，[poj2253](src/EarlyStage/GraphAlgs/poj2253.java)，[poj1125](src/EarlyStage/GraphAlgs/poj1125.java)，poj2240）
...
4. 简单搜索：
    ...
    - 简单搜索技巧和减枝（[poj2531](src/EarlyStage/SimpleSearch/poj2531.java)，[poj1416](src/EarlyStage/SimpleSearch/poj1416.java)，[poj2676](src/EarlyStage/SimpleSearch/poj2676.java)，[poj1129](src/EarlyStage/SimpleSearch/poj1129.java)）
