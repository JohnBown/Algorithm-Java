...
6. 数学：
    - 组合数学
        ...
        - 排列组合
        - 递推关系
    （[poj3252](src/EarlyStage/Mathematics/poj3252.java)，[poj1850](src/EarlyStage/Mathematics/poj1850.java)，[poj1019](src/EarlyStage/Mathematics/poj1019.java)，poj1942）
    - 数论
        - 素数与整数问题
        - 进制位
        - 同余模运算
